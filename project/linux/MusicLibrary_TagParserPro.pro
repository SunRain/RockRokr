...
include ($${PHOENIX_PLUGIN_PATH}/DataProvider/TagParserPro/TagParserPro.pri)
include(plugins_common_cmd.pri)

include ($${PHOENIX_PLUGIN_PATH}/DataProvider/TagParserPro/Taglib/Taglib.pri)
LIBS += -ltag_mod

TAGLIB_BUILD_DIR = $${OUT_PWD}/Taglib/build
TAGLIB_TARGET_DIR = $${OUT_PWD}/Taglib/target
BUILD_TAGLIB = cd $${TAGLIB_BUILD_DIR} \
    && cmake $${PHOENIX_PLUGIN_PATH}/DataProvider/TagParserPro/Taglib/src -DCMAKE_INSTALL_PREFIX=$${TAGLIB_TARGET_DIR} -DCMAKE_RELEASE_TYPE=Release \
    && make \
    && make install
